...
const createKeyReviews = (
  ...
  return createReviews(
    ...
    {
      iconComment:
        icons?.key_reviewer_comment ?? ICON_KEY_REVIEWER_COMMENT,
      iconChanges:
        icons?.key_reviewer_changes ?? ICON_KEY_REVIEWER_CHANGES,
      iconApproved:
        icons?.key_reviewer_approved ?? ICON_KEY_REVIEWER_APPROVED,
